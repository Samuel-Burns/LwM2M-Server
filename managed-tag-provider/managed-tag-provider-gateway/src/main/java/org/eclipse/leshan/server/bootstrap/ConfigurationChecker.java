...
public class ConfigurationChecker {
    ...
    public void verify(BootstrapConfig config) throws InvalidConfigurationException {
        ...
        for (Map.Entry<Integer, ServerSecurity> e : config.security.entrySet()) {
            ServerSecurity sec = e.getValue();
    ...
    protected void validateOneSecurityByServer(BootstrapConfig config) throws InvalidConfigurationException {
        for (Map.Entry<Integer, BootstrapConfig.ServerConfig> e : config.servers.entrySet()) {
            ...
            ServerSecurity security = getSecurityEntry(config, srvCfg.shortId);
    ...
    protected static ServerSecurity getSecurityEntry(BootstrapConfig config, int shortId) {
        for (Map.Entry<Integer, ServerSecurity> es : config.security.entrySet()) {
